...
export interface AnimatedBeamProps {
  ...
  isActive?: boolean; // New prop: whether the animation is active
  color?: string; // Alias for gradientStartColor/gradientStopColor
}
...
export const AnimatedBeam: React.FC<AnimatedBeamProps> = ({
  ...
  color, // Alias for gradient colors
}) => {
  // Use color as gradient colors if provided
  const effectiveGradientStartColor = color || gradientStartColor;
  const effectiveGradientStopColor = color || gradientStopColor;
  const effectiveParticleColor = color || particleColor;
    ...
    >
      ...
      {showParticlesState && pathLength > 0 && (
        <>
          ...
          <circle r={particleSize} fill={effectiveParticleColor}>
            <animateMotion
              path={
      ...
      <defs>
        ...
        >
          <stop stopColor={effectiveGradientStartColor} stopOpacity="0" />
          <stop stopColor={effectiveGradientStartColor} />
          <stop offset="32.5%" stopColor={effectiveGradientStopColor} />
          <stop
            offset="100%"
            stopColor={effectiveGradientStopColor}
            stopOpacity="0"
          />
        </motion.linearGradient>
      </defs>
